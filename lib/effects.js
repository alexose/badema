$(document).ready(function(){
    ...
    function pointQuery(x,y,map) {
        ...
        var X = 10;
        var Y = 10;
        var URL = 'http://ec2-23-21-2-183.compute-1.amazonaws.com:8080/geoserver/gwc/service/wms&REQUEST=GetFeatureInfo&LAYERS=cleanweb:net_radiation_rgb_201106&QUERY_LAYERS=cleanweb:net_radiation_rgb_201106&STYLES=&BBOX='+BBOX+'&FEATURE_COUNT=5&HEIGHT='+HEIGHT+'&WIDTH='+WIDTH+'&FORMAT=image%2Fpng&INFO_FORMAT=text%2Fhtml&SRS=EPSG%3A4326&X='+X+'&Y='+Y;
